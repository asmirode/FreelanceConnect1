    ...
    return ([
        <div className="home">
            ...
            <div className="features dark">
                <div className="container">
                    <div className="item">
                        <h1>FreelanceConnect  <em><span style={{ fontWeight: '300' }}>AI Matching.</span></em></h1>
                        <h1>A solution built for <em>buyers</em></h1>
            ...
            <div className="last_hero">
                <div className="items">
                    <div className="left">
                        ...
                        <button onClick={e => navigate(`/register`)}>Join FreelanceConnect</button>
                    </div>
                    <div className="right">
